c*********************************************************************
       SUBROUTINE STOB_STOP_CHEBY_TAB(WINT,XWINT,YWINT)
c*********************************************************************
c
...
c
       open(10,file='data/STOB_STOP_CHEBY_TAB.dat',form='unformatted')
       do i=1,7
       do j=1,21
       do k=0,3
       do l=1,12
...
cccccccccc
       return
cccccccccc
       open(10,file='data/XSTOB_STOP_CHEBY_TAB.dat',form='unformatted')
       do i=1,7
       do j=1,21
       do k=0,3
       do l=1,12
       ...
       close(10)
c
       open(10,file='data/YSTOB_STOP_CHEBY_TAB.dat',form='unformatted')
       do i=1,7
       do j=1,21
       do k=0,3
       do l=1,12
...
c
       ...
       END
c
       SUBROUTINE STOB_ST_CORRECT_TAB(WINT,XWINT,YWINT)
c*********************************************************************
c
...
c
       open(10,file='data/STOB_ST_CORRECT_TAB.dat',form='unformatted')
       do i=1,7
       do j=0,3
       do k=1,12
       do l=1,16
...
cccccccccc
c
       open(10,file='data/XSTOB_ST_CORRECT_TAB.dat',form='unformatted')
       do i=1,7
       do j=0,3
       do k=1,12
       do l=1,16
       ...
       close(10)
c
       open(10,file='data/YSTOB_ST_CORRECT_TAB.dat',form='unformatted')
       do i=1,7
       do j=0,3
       do k=1,12
       do l=1,16
