c*********************************************************************
       SUBROUTINE BTOS_DTOP_CHEBY_TAB(WINT,XWINT,YWINT)
c*********************************************************************
c
c      the precomputed table for big to small double layer top 
c        interaction
c
c      output :
...
c
       open(10,file='data/BTOS_DTOP_CHEBY_TAB.dat',form='unformatted')
       do i=1,7
       do j=1,21
       do k=0,3
       do l=1,12
...
ccccccccccccccc
c
       open(10,file='data/XBTOS_DTOP_CHEBY_TAB.dat',form='unformatted')
       do i=1,7
       do j=1,21
       do k=0,3
       do l=1,12
       ...
       close(10)
c
       open(10,file='data/YBTOS_DTOP_CHEBY_TAB.dat',form='unformatted')
       do i=1,7
       do j=1,21
       do k=0,3
       do l=1,12
...
c
       ...
       END
c
       SUBROUTINE BTOS_DT_CORRECT_TAB(WINT,XWINT,YWINT)
c*********************************************************************
c
...
c
       open(10,file='data/BTOS_DT_CORRECT_TAB.dat',form='unformatted')
       do i=1,7
       do j=0,3
       do k=1,12
       do l=1,16
...
ccccccccc
       return
cccccccccc
       open(10,file='data/XBTOS_DT_CORRECT_TAB.dat',form='unformatted')
       do i=1,7
       do j=0,3
       do k=1,12
       do l=1,16
       ...
       close(10)
c
       open(10,file='data/YBTOS_DT_CORRECT_TAB.dat',form='unformatted')
       do i=1,7
       do j=0,3
       do k=1,12
       do l=1,16
